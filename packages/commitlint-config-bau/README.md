...
In order to automatically trigger commit on every message, you'll want to also setup [husky](https://www.npmjs.com/package/husky) in your `package.json`:
...
we use the git commit messages to **automatically generate changelogs and versions**.
